...
namespace Factory.Controllers;
  ...
  public class MachinesController : Controller
  {
    ...
    {
  #nullable enable
      EngMachine? joinEntity = _db.EngMachines.FirstOrDefault(join => (join.EngineerId == engineerId && join.MachineId == machine.MachineId));
  #nullable disable 
      if (joinEntity == null && engineerId !=0)
      {
        _db.EngMachines.Add(new EngMachine() { EngineerId = engineerId, MachineId = machine.MachineId});
        _db.SaveChanges();
      }
